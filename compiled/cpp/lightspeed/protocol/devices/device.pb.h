...
// string address = 4;
inline void ProtoDevice::clear_address() {
  address_.ClearToEmpty();
}
inline const std::string& ProtoDevice::address() const {
  // @@protoc_insertion_point(field_get:lightspeed.devices.ProtoDevice.address)
  return _internal_address();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ProtoDevice::set_address(ArgT0&& arg0, ArgT... args) {
 
 address_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:lightspeed.devices.ProtoDevice.address)
}
inline std::string* ProtoDevice::mutable_address() {
  std::string* _s = _internal_mutable_address();
  // @@protoc_insertion_point(field_mutable:lightspeed.devices.ProtoDevice.address)
  return _s;
}
inline const std::string& ProtoDevice::_internal_address() const {
  return address_.Get();
}
inline void ProtoDevice::_internal_set_address(const std::string& value) {
  
  address_.Set(value, GetArenaForAllocation());
}
inline std::string* ProtoDevice::_internal_mutable_address() {
  
  return address_.Mutable(GetArenaForAllocation());
}
inline std::string* ProtoDevice::release_address() {
  // @@protoc_insertion_point(field_release:lightspeed.devices.ProtoDevice.address)
  return address_.Release();
}
inline void ProtoDevice::set_allocated_address(std::string* address) {
  if (address != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:lightspeed.devices.ProtoDevice.address)
}

// int32 baud = 5;
inline void ProtoDevice::clear_baud() {
  baud_ = 0;
}
inline int32_t ProtoDevice::_internal_baud() const {
  return baud_;
}
inline int32_t ProtoDevice::baud() const {
  // @@protoc_insertion_point(field_get:lightspeed.devices.ProtoDevice.baud)
  return _internal_baud();
}
inline void ProtoDevice::_internal_set_baud(int32_t value) {
  
  baud_ = value;
}
inline void ProtoDevice::set_baud(int32_t value) {
  _internal_set_baud(value);
  // @@protoc_insertion_point(field_set:lightspeed.devices.ProtoDevice.baud)
}
...
inline ::lightspeed::devices::ProtoDevice_Family ProtoDevice::_internal_family() const {
  return static_cast< ::lightspeed::devices::ProtoDevice_Family >(family_);
}
