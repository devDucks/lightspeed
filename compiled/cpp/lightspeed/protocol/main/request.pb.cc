...
static ::_pb::Metadata file_level_metadata_protocol_2fmain_2frequest_2eproto[11];
...
const uint32_t TableStruct_protocol_2fmain_2frequest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::lightspeed::request::GetPropertiesRequest, _impl_.device_name_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::lightspeed::request::GetPropertyRequest, _impl_.device_name_),
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::lightspeed::request::SetPropertyRequest, _impl_.device_name_),
...
const ::_pbi::DescriptorTable descriptor_table_protocol_2fmain_2frequest_2eproto = {
    false, false, 676, descriptor_table_protodef_protocol_2fmain_2frequest_2eproto,
    "protocol/main/request.proto",
    &descriptor_table_protocol_2fmain_2frequest_2eproto_once, nullptr, 0, 11,
...
::PROTOBUF_NAMESPACE_ID::Metadata CcdAbortExposureRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_protocol_2fmain_2frequest_2eproto_getter, &descriptor_table_protocol_2fmain_2frequest_2eproto_once,
      file_level_metadata_protocol_2fmain_2frequest_2eproto[8]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata CcdAbortExposureResponse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_protocol_2fmain_2frequest_2eproto_getter, &descriptor_table_protocol_2fmain_2frequest_2eproto_once,
      file_level_metadata_protocol_2fmain_2frequest_2eproto[9]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata EfwCalibrationRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_protocol_2fmain_2frequest_2eproto_getter, &descriptor_table_protocol_2fmain_2frequest_2eproto_once,
      file_level_metadata_protocol_2fmain_2frequest_2eproto[10]);
}
